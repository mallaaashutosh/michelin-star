<%--
    File: index.jsp
    Purpose: Public marketing home page served from WEB-INF (included layout)
    Description: Renders hero section, features, menu highlights, story, and testimonials
--%>
...
<section class="section">
    <div class="section-title">
        ...
        <p>Discover our chef's carefully crafted specialties.</p>
    </div>
    <div class="menu-grid">
        <div class="menu-card">
        ...
        <div class="menu-card">
            <img src="https://images.unsplash.com/photo-1473093295043-cdd812d0e601?q=80&w=2070&auto=format&fit=crop"
                 alt="Truffle Pasta">
            <div class="menu-content">
                <h3>Truffle Pasta</h3>
                <p>
...
<section class="section">
    <div class="section-title">
        ...
        <p>Hear what our valued guests say about us.</p>
    </div>
